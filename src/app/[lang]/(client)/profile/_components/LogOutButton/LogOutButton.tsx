...
export function LogOutButton({ lang }: LogOutButtonProps) {
  ...
  return (
    <button
      className="p-2 hover:text-alert flex items-center gap-3 text-lg ml-auto disabled:hover:text-black dark:disabled:hover:text-custom-white disabled:opacity-75"
      onClick={logOut}
      disabled={loading}
    >
      {loading
